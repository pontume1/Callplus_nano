...
public class addContact extends AppCompatActivity {
    ...
    private ImageButton savePhoneContactButton;
    private ImageButton cancle_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savePhoneContactButton = (ImageButton)findViewById(R.id.add_phone_contact_save_button);
        cancle_button = (ImageButton)findViewById(R.id.cancle_button);
