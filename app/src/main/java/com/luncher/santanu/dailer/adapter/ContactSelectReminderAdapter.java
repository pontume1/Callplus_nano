...
public class ContactSelectReminderAdapter extends RecyclerView.Adapter<ContactSelectReminderAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            txtFooter = (TextView) v.findViewById(com.luncher.santanu.dailer.R.id.secondLine);
        }
    }
    ...
    public ContactSelectReminderAdapter(List<String> myDataset, List<String> phoneNo, String message, Long time, Integer timeAgo) {
        values = myDataset;
        phone_no = phoneNo;
        sel_message = message;
        sel_time = time;
    ...
    public ContactSelectReminderAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        LayoutInflater inflater = LayoutInflater.from(
                parent.getContext());
        View v =
                inflater.inflate(com.luncher.santanu.dailer.R.layout.select_contact, parent, false);
