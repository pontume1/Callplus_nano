...
public class ContactSelectSosAdapter extends RecyclerView.Adapter<ContactSelectSosAdapter.ViewHolder> {
    ...
    public ContactSelectSosAdapter(List<String> myDataset, List<String> phoneNo, String message, Long time, Integer timeAgo, List<Boolean> selected, RecyclerViewClickListener itemListeners) {
        values = myDataset;
        phone_no = phoneNo;
        sel_message = message;
        sel_time = time;
    ...
    @Override
    public ContactSelectSosAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                 int viewType) {
        ...
        LayoutInflater inflater = LayoutInflater.from(
                parent.getContext());
        View v =
                inflater.inflate(R.layout.select_contact, parent, false);
