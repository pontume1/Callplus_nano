...
public class SelectReminderContact extends Activity implements RecyclerViewClickListener {
                ...
                for (int i = 0; i < contacts.size(); i++) {
                    ...
                    if(name.toLowerCase().contains(query)) {
                        ...
                        if (contacts.get(i).getPhoneNumbers().get(0).getNormalizedNumber() == null) {
                            ...
                            phNo = contacts.get(i).getPhoneNumbers().get(0).getNormalizedNumber().toString();
                        }
