...
//
//                    MyDbHelper myDbHelper = new MyDbHelper(ReminderDialogGroup.this, null, 1);
            ...
            dialog_share.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    for (int i=0; i<phone_no.size(); i++) {
                        ...
                        Reminder reminder = new Reminder(mPhoneNo, c_no, message, time, remindAgo, shared_with.toString(), false, "none", false, tsLong.toString(), false, key);
                    ...
                    MyDbHelper myDbHelper = new MyDbHelper(ReminderDialogGroup.this, null, 8);
...
//                    alarmManager.setExact(AlarmManager.RTC, noti_time, pendingNotiIntent);
    ...
    private void choosePhoneNo() {
        Intent intent = new Intent(this, SelectReminderGroupContact.class);
        intent.putStringArrayListExtra("phone_nos", (ArrayList<String>)phone_no);
